...
const CREDITS_DATA = [
  { name: "김도경 (드럼)", comment: "파일을 합칠 때나 싱크를 조절할 때 등 어려움을 겪었던 순간들은 많았지만\n이렇게 결국 성공적으로 완성하고 나니 정말 뿌듯합니다!\n드럼 파트가 어려운 편이라 \n플레이어 분들이 도전정신을 갖고 즐겁게 즐겨주셨으면 좋겠습니다:) 🥁" },
  { name: "김도현 (베이스)", comment: "이번 학기 첫 팀플을 만족스럽게 마친 것 같아 기쁩니다.\n여러 요소가 있는 게임인 만큼 어쩌면 정신 사나울 수 있지만\n그것이 바로 이 게임의 매력이라고 생각합니다! 🎸" },
  { name: "방준혁 (건반)", comment: "이정도로 완성도 있게 구현이 될 줄은 몰랐습니다..\n팀원들과 열심히 한 만큼 나온 결과물이라고 생각합니다! 🎹" }
];
...
const HELP_PAGES_DATA = [
  {
    ...
    desc: "상단에서 노트가 내려옵니다!\n피아노의 건반에 배치된 적절한 키를 눌러 연주하세요."
  },
  {
    title: "< 2. 베이스 플레이 방법 >",
    gifName: "bass.gif",
    desc: "마우스를 지정된 줄에 올립니다.\n그 후 스페이스바를 클릭하여 연주합니다."
  },
  {
    title: "< 3. 드럼 플레이 방법 >",
    gifName: "drum.gif",
